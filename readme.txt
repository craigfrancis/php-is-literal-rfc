...
The first two need the values to be quoted, but would be considered "untained" (wrong). The third example, well htmlentities, before PHP 8.1 ([[https://github.com/php/php-src/commit/50eca61f68815005f3b0f808578cc1ce3b4297f0|thank you very much]]) does not escape single quotes by default, and it does not consider what happens with 'javascript:' URLs.
