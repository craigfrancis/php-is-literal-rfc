...
===== Alternatives =====
  ...
  - Using static analysis (not at runtime), for example [[https://psalm.dev/|psalm]] (thanks [[https://news-web.php.net/php.internals/109192|Tyson Andre]]). But I can't find any tools which do anything like this, and we can't expect all programmers (especially those who have just stated) to use static analysis.
