...
[Additional Examples](https://github.com/craigfrancis/php-is-literal-rfc/blob/main/justification/mistakes.php), and see tools such as SQL Map, Havij, jSQL, etc.
